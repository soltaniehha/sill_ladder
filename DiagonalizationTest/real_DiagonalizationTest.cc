...
void Diagonalize_real(int, Matrix<double>, Matrix<double> &, Vector<double> &);
...
int main()
{
	...
	//CALLUING LINE
	Diagonalize_real(dim,H,EigVec,energy);
...
void Diagonalize_real(int dim, Matrix<double> mat, Matrix<double> &evect, Vector<double> &eval)
{
